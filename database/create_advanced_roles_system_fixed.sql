-- Sistema Avanzado de Roles y Permisos - VERSIÓN CORREGIDA COLLATIONS
-- Permite que un usuario tenga múltiples roles y un rol sea usado por múltiples usuarios

-- Establecer collation consistente
SET NAMES utf8mb4;
...
CREATE TABLE IF NOT EXISTS roles (
    ...
    name VARCHAR(50) NOT NULL UNIQUE COLLATE utf8mb4_general_ci,
    display_name VARCHAR(100) NOT NULL COLLATE utf8mb4_general_ci,
    description TEXT COLLATE utf8mb4_general_ci,
    color VARCHAR(20) DEFAULT '#6B7280' COLLATE utf8mb4_general_ci,
    icon VARCHAR(50) DEFAULT 'user' COLLATE utf8mb4_general_ci,
...
CREATE TABLE IF NOT EXISTS permissions (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(100) NOT NULL UNIQUE COLLATE utf8mb4_general_ci,
    display_name VARCHAR(100) NOT NULL COLLATE utf8mb4_general_ci,
    description TEXT COLLATE utf8mb4_general_ci,
    module VARCHAR(50) NOT NULL COLLATE utf8mb4_general_ci, -- 'orders', 'users', 'logistics', 'billing', etc.
    action VARCHAR(50) NOT NULL COLLATE utf8mb4_general_ci, -- 'view', 'create', 'edit', 'delete', 'manage', etc.
    resource VARCHAR(50) COLLATE utf8mb4_general_ci, -- 'all', 'own', 'assigned', etc.
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS role_views (
    id INT AUTO_INCREMENT PRIMARY KEY,
    role_id INT NOT NULL,
    view_name VARCHAR(100) NOT NULL COLLATE utf8mb4_general_ci, -- 'dashboard', 'orders', 'logistics', etc.
...
WHERE BINARY u.role = 'admin' AND r.name = 'super_admin'
...
SELECT u.id, r.id, 1
FROM users u, roles r
WHERE BINARY u.role = r.name AND u.role != 'admin'
ON DUPLICATE KEY UPDATE assigned_by = VALUES(assigned_by);
